const stage = document.querySelector<HTMLElement>('[data-lag-stage]');
const nowDot = document.querySelector<HTMLElement>('[data-lag-now]');
const laterDot = document.querySelector<HTMLElement>('[data-lag-later]');
const hint = stage?.querySelector<HTMLElement>('.lag-stage__hint');
